...
old = """// Fin automatique d'un blocus syndical si aucun des deux leaders (Secretaire General ou
...
print("✅ Cron d'expiration corrigé : utilise maintenant le bon horodatage (dernierRenouvellementTimestamp).")
