...
# Le payload des 48 colonnes a ete extrait dans sbPayloadPersonnage (chantier B,
# 13 septembre 2026) pour que la PREMIERE ecriture d'un personnage emprunte les
# memes champs sans les recopier : le controle suit le bloc la ou il vit desormais.
save = SUPABASE[SUPABASE.find('function sbPayloadPersonnage'):]
save = save[:save.find('\n}\n')]
