...
# --- 3b. Retirer les ordres redondants, format vertical (lot 1 uniquement) ---
old_3b = """          {fn:'deposer_demande_permis', label:'Déposer une demande de permis', pa:2, cost:0, type:'legal', icon:'ti-file-text', successRate:100, desc:'Toujours obtenu a terme -- seule la duree d\\'instruction varie selon le palier choisi.'},
...
"""
new_3b = """"""
nb3b = content.count(old_3b)
assert nb3b == 1, f"bloc 3b (format vertical, lot 1) : trouvé {nb3b} fois (attendu 1)"
content = content.replace(old_3b, new_3b)

with open(PATH, "w", encoding="utf-8") as f:
    f.write(content)

print(f"✅ Nettoyage terminé : doublon lot 1 retiré, prix compromis (5x) corrigé à 1000 FR, ordres redondants (5x au total) supprimés.")
