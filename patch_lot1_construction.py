...
old = """          {fn:'acheter_terrain', label:'Acheter ce terrain (2150 m² — 25 800 FR)', pa:2, cost:25800, type:'legal', icon:'ti-home-plus', successRate:100},
          {fn:'racheter_terrain', label:'Offre de rachat', pa:2, cost:0, type:'legal', icon:'ti-arrows-exchange', successRate:100}
        ]
      }
    }"""
new = """          {fn:'acheter_terrain', label:'Acheter ce terrain (2150 m² — 25 800 FR)', pa:2, cost:25800, type:'legal', icon:'ti-home-plus', successRate:100},
          {fn:'construire_sur_terrain', label:'Construire', pa:0, cost:0, type:'legal', icon:'ti-building', successRate:100},
...
print("✅ Lot 1 corrigé : ajout de Construire/Emprunter (manquants), et des 3 nouveaux ordres de subdivision.")
