...
// copropriete du conjoint). Appelee soit par un achat direct instantane a l'ancienne (usage
// interne restant), soit — bientot — par la signature finale chez le notaire, que ce soit a
...
print("✅ Logique de finalisation extraite dans finaliserAchatTerrain(), réutilisable pour le notaire.")
