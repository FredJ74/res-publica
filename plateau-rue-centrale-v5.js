  ...
  republic: {
    ...
    'luthecia-centre-commercial': {
      ...
      zones: [
        ...
        // a ajuster si besoin.
        { xPct: [40, 70],  nom: 'Centre Commercial Luthécia', type: 'batiment', buildingId: 'centre-commercial' },
        { xPct: [70, 100], nom: 'Centre d\'Affaires',          buildingId: 'centre-affaires' }
      ],
...
function afficherNoeudRue(pays, noeudId) {
  ...
  const stylesParDefaut = {
    ...
    toutDroit: 'top:50%; left:64%; transform:translate(-50%,-50%);',
  ...
  noeud.zones.forEach(z => {
    ...
    // Effet de grossissement leger centre sur le batiment survole (remplace l'ancien cadre dore) :
    // on zoome legerement toute l'image, mais avec le point d'origine du zoom place au centre
    // horizontal de la zone survolee, ce qui donne l'impression que ce batiment precis s'agrandit.
