...
const PLAN_LAYOUTS = {
  capitale: {
    // Plan base sur le croquis de Fred, rotation 180 degres appliquee (Quartier des Ambassades
    // en haut, Grande Rue en bas — Palais a gauche, Imprimerie a droite). Tabernacle, Marche,
    // Armurerie et Terrains/Centre Artisanal sont 4 zones distinctes le long de la route qui
    // remonte de l'Imprimerie, plutot que 2 blocs regroupes comme dans la version precedente.

    // Quartier des Ambassades (tout en haut)
    'quartier-ambassades':         [300,   4, 180, 36],

    // Stade / Centre Commercial / Centre d'Affaires / Centre Multimodal (juste en dessous)
    'centre-multinodal-luthecia':  [ 50,  46, 140, 50],
    'centre-affaires':             [320,  46, 110, 50],
    'centre-commercial':           [438,  46, 110, 50],
    'stade':                       [556,  46, 110, 50],

    // Terrains a batir (5 lots)
    'terrain-a-batir-7':           [184, 102,  90, 50],
    'terrain-a-batir-6':           [282, 102,  90, 50],
    'terrain-a-batir-5':           [380, 102,  90, 50],
    'terrain-a-batir-4':           [478, 102,  90, 50],
    'terrain-a-batir-1':           [576, 102,  90, 50],

    // Centre Artisanal
    'centre-artisanal':            [ 50, 158, 140, 50],

    // Marche + Armurerie
    'marche':                      [ 50, 214, 140, 50],
    'armurerie':                   [210, 214, 120, 50],

    // Tabernacle des Impots
    'tabernacle-impots':           [ 50, 270, 140, 50],

    // Grande rue — scene "Imprimerie" (fin de la grande rue)
    'la-tribune':                  [320, 333, 110, 55],
    'dispensaire-public':          [438, 333, 110, 55],
    'universite':                  [556, 333, 110, 55],

    // Grande rue — scene "Loge"
    'commissariat':                [232, 401, 110, 55],
    'loge-maconnique':             [350, 401, 100, 55],
    'clinique-privee':             [458, 401, 100, 55],
    'banque-privee':               [566, 401, 100, 55],

    // Grande rue — scene "Hotel de Ville"
    'banque-nationale':            [202, 469, 100, 55],
    'hotel-republica':             [310, 469, 140, 55],
    'office-notarial':             [458, 469, 100, 55],
    'mairie-capitale':             [566, 469, 100, 55],

    // Grande rue — scene "Palais Presidentiel" (debut de la grande rue, tout en bas)
    'tribunal':                    [242, 537, 100, 55],
    'assemblee':                   [350, 537, 100, 55],
    'palais-gouvernement':         [458, 537, 100, 55],
    'palais-presidentiel':         [566, 537, 100, 55],
  },
  ville_a: {
