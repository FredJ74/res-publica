...
const PLAN_LAYOUTS = {
  capitale: {
    // Plan aligne sur la VRAIE circulation de la rue centrale (voir plateau-rue-centrale.js) :
    // - Grande rue (haut-gauche, 4 rangees = les 4 scenes Palais/Hotel de Ville/Loge/Imprimerie)
    // - Boucle Stade/Multimodal (haut-droite), rejoint l'Imprimerie
    // - Boucle Commerce/Terrains/Armurerie/Tabernacle (bas), rejoint le Palais Presidentiel
    // - Quartier des Ambassades (bas-droite), relie l'intersection, les Terrains et le Multimodal
    // Rangee 1 — scene "Palais Presidentiel"
    'palais-presidentiel':         [ 14,  12, 100, 60],
    'palais-gouvernement':         [122,  12, 100, 60],
    'assemblee':                   [230,  12, 100, 60],
    'tribunal':                    [338,  12, 100, 60],
    // Rangee 2 — scene "Hotel de Ville"
    'mairie-capitale':             [ 14,  84, 100, 60],
    'office-notarial':             [122,  84, 100, 60],
    'hotel-republica':             [230,  84, 140, 60],
    'banque-nationale':            [378,  84, 100, 60],
    // Rangee 3 — scene "Loge"
    'banque-privee':               [ 14, 156, 100, 60],
    'clinique-privee':             [122, 156, 100, 60],
    'loge-maconnique':             [230, 156, 100, 60],
    'commissariat':                [338, 156, 110, 60],
    // Rangee 4 — scene "Imprimerie"
    'universite':                  [ 14, 228, 110, 60],
    'dispensaire-public':          [132, 228, 110, 60],
    'la-tribune':                  [250, 228, 110, 60],
    // Boucle Stade / Multimodal (rejoint l'Imprimerie)
    'stade':                       [480,  12, 100, 70],
    'centre-multinodal-luthecia':  [480,  90, 100, 70],
    // Boucle Commerce / Terrains / Armurerie / Tabernacle (rejoint le Palais Presidentiel)
    'centre-affaires':             [ 14, 320, 100, 60],
    'centre-commercial':           [122, 320, 100, 60],
    'centre-artisanal':            [230, 320, 100, 60],
    'armurerie':                   [338, 320, 100, 60],
    'tabernacle-impots':           [446, 320, 100, 60],
    'marche':                      [560, 320, 100, 60],
    // Terrains a batir (vue rapprochee, sous-scene de Terrains Artisanal)
    'terrain-a-batir-1':           [ 14, 392,  80, 60],
    'terrain-a-batir-4':           [100, 392,  80, 60],
    'terrain-a-batir-5':           [186, 392,  80, 60],
    'terrain-a-batir-6':           [272, 392,  80, 60],
    'terrain-a-batir-7':           [358, 392,  80, 60],
    // Quartier des Ambassades — relie l'intersection, les Terrains Artisanal et le Multimodal
    'quartier-ambassades':         [480, 320, 110, 70],
  },
  ville_a: {
