...
const BUILDINGS = {
  ...
  'office-notarial': {
    ...
    rooms: {
      ...
      bureau_contrats: {
        ...
        orders: [
          {fn:'officialiser_transaction', label:'Officialiser une transaction', pa:1, cost:0, type:'legal', icon:'ti-home-check', successRate:100, desc:'Finaliser une vente de terrain ou un rachat d\'entreprise avec compromis actif. Le notaire authentifie la transaction.'},
          ...
          {fn:'transfert_compromis', label:'Transfert de compromis', pa:1, cost:0, type:'legal', icon:'ti-transfer', successRate:100, desc:'Céder un compromis en cours à un autre joueur, ou accepter un transfert qui vous est proposé.'},
          {fn:'demander_divorce', label:'Divorcer', pa:1, cost:200, type:'legal', icon:'ti-heart-broken', successRate:100, desc:'Dissout immédiatement votre mariage, sans l\'accord de votre conjoint. Il/elle en sera informé(e) par mail. Action instantanée et irréversible.'},
  ...
  'terrain-a-batir-4': {
    ...
    rooms: { terrain: { name: "Terrain vague", imageBg: "linear-gradient(135deg,#0a0a05,#12120a)", desc: "Le plus petit lot de la Châtaigneraie (1850 m²), en fond de parcelle.", imageUrl: "https://images.unsplash.com/photo-1590496793929-36417d3117de?w=1200&q=80", persons: [], orders: [{fn:'appeler_police_terrain', label:'Appeler la police', pa:1, cost:0, type:'legal', icon:'ti-shield', successRate:100},{fn:'faire_disparaitre_cadavre', label:'Faire disparaitre le corps', pa:2, cost:0, type:'illegal', icon:'ti-eye-off', successRate:0, requiresCadavre:true},{fn:'negocier_squatteurs', label:'Negocier le depart', pa:1, cost:0, type:'legal', icon:'ti-messages', successRate:0, requiresSquatteurs:true},{fn:'signer_compromis', label:'Signer un compromis', pa:2, cost:1000, type:'legal', icon:'ti-file-certificate', successRate:100},
          {fn:'acheter_terrain', label:'Acheter ce terrain (1850 m² — 22 200 FR)', pa:2, cost:22200, type:'legal', icon:'ti-home-plus', successRate:100},{fn:'construire_sur_terrain', label:'Construire', pa:0, cost:0, type:'legal', icon:'ti-building', successRate:100},{fn:'corrompre_rdv_notaire', label:'Accélérer le rendez-vous (corruption)', pa:2, cost:800, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant avant le rendez-vous notarial d\'un achat direct.'},{fn:'payer_versement_chantier', label:'Payer le versement du chantier', pa:0, cost:0, type:'legal', icon:'ti-cash', successRate:100, desc:'Régler le versement en attente pour que le chantier reprenne.'},{fn:'travailler_chantier', label:'Travailler sur le chantier', pa:0, cost:0, type:'legal', icon:'ti-hammer', successRate:100, desc:'Une heure de travail = 1 PA, payee 70 FR par la tresorerie du chantier. Vous devez etre sur place.'},{fn:'vendre_materiaux_chantier', label:'Fournir le chantier', pa:0, cost:0, type:'legal', icon:'ti-truck-delivery', successRate:100, desc:'Vendre vos bois, minerai ou metal au chantier, au prix que vous fixez. Vous devez etre sur place.'},{fn:'modifier_plan_chantier', label:'Modifier le plan de decoupage', pa:0, cost:0, type:'legal', icon:'ti-layout-grid', successRate:100, desc:'Remanier gratuitement le decoupage en lots tant que le chantier n a pas atteint les deux tiers. Reserve au proprietaire.'},{fn:'corrompre_chantier', label:'Accélérer le chantier (corruption)', pa:2, cost:1500, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant du chantier.'},{fn:'voler_materiel_chantier', label:'Voler du matériel de chantier', pa:2, cost:0, type:'illegal', icon:'ti-truck', successRate:0, desc:'Même le propriétaire peut se voler lui-même — mise en scène parodique, bonus de sympathie publique.'},{fn:'diviser_construction', label:'Diviser / gérer les lots', pa:0, cost:0, type:'legal', icon:'ti-grid-dots', successRate:100, desc:'Réservé aux Commerces Premium et Buildings construits.'},{fn:'reconfigurer_lots', label:'Reconfigurer les lots (chantier)', pa:0, cost:0, type:'legal', icon:'ti-layout-board', successRate:100, desc:'Redecouper un batiment livre : 10 FR par m2 reellement concerne, paye en totalite au lancement. Aucun local sous bail ne peut etre touche.'},{fn:'louer_lot_ici', label:'Louer un lot ici', pa:1, cost:0, type:'legal', icon:'ti-key', successRate:100, desc:'Louer un lot disponible, si ce terrain a été divisé par son propriétaire.'},{fn:'gerer_lot_loue', label:'Gérer mon local loué', pa:0, cost:0, type:'legal', icon:'ti-home-cog', successRate:100, desc:'Voir/accepter les propositions du propriétaire concernant votre lot loué ici.'},{fn:'gerer_fonds_commerce', label:'Mon fonds de commerce', pa:0, cost:0, type:'legal', icon:'ti-building-store', successRate:100, desc:'Creer un fonds de commerce dans ce local, ou gerer sa caisse. Reserve au titulaire du bail.'},{fn:'emprunter_construction', label:'Faire un prêt (Banque Nationale)', pa:0, cost:0, type:'legal', icon:'ti-bank', successRate:100},{fn:'racheter_terrain', label:'Offre de rachat', pa:2, cost:0, type:'legal', icon:'ti-arrows-exchange', successRate:100}] } }
  },
  'terrain-a-batir-5': {
    ...
    rooms: { terrain: { name: "Terrain vague", imageBg: "linear-gradient(135deg,#0a0a05,#12120a)", desc: "Le plus vaste lot de la Châtaigneraie (2750 m²), comprenant l'ancien verger.", imageUrl: "https://images.unsplash.com/photo-1590496793929-36417d3117de?w=1200&q=80", persons: [], orders: [{fn:'appeler_police_terrain', label:'Appeler la police', pa:1, cost:0, type:'legal', icon:'ti-shield', successRate:100},{fn:'faire_disparaitre_cadavre', label:'Faire disparaitre le corps', pa:2, cost:0, type:'illegal', icon:'ti-eye-off', successRate:0, requiresCadavre:true},{fn:'negocier_squatteurs', label:'Negocier le depart', pa:1, cost:0, type:'legal', icon:'ti-messages', successRate:0, requiresSquatteurs:true},{fn:'signer_compromis', label:'Signer un compromis', pa:2, cost:1000, type:'legal', icon:'ti-file-certificate', successRate:100},
          {fn:'acheter_terrain', label:'Acheter ce terrain (2750 m² — 33 000 FR)', pa:2, cost:33000, type:'legal', icon:'ti-home-plus', successRate:100},{fn:'construire_sur_terrain', label:'Construire', pa:0, cost:0, type:'legal', icon:'ti-building', successRate:100},{fn:'corrompre_rdv_notaire', label:'Accélérer le rendez-vous (corruption)', pa:2, cost:800, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant avant le rendez-vous notarial d\'un achat direct.'},{fn:'payer_versement_chantier', label:'Payer le versement du chantier', pa:0, cost:0, type:'legal', icon:'ti-cash', successRate:100, desc:'Régler le versement en attente pour que le chantier reprenne.'},{fn:'travailler_chantier', label:'Travailler sur le chantier', pa:0, cost:0, type:'legal', icon:'ti-hammer', successRate:100, desc:'Une heure de travail = 1 PA, payee 70 FR par la tresorerie du chantier. Vous devez etre sur place.'},{fn:'vendre_materiaux_chantier', label:'Fournir le chantier', pa:0, cost:0, type:'legal', icon:'ti-truck-delivery', successRate:100, desc:'Vendre vos bois, minerai ou metal au chantier, au prix que vous fixez. Vous devez etre sur place.'},{fn:'modifier_plan_chantier', label:'Modifier le plan de decoupage', pa:0, cost:0, type:'legal', icon:'ti-layout-grid', successRate:100, desc:'Remanier gratuitement le decoupage en lots tant que le chantier n a pas atteint les deux tiers. Reserve au proprietaire.'},{fn:'corrompre_chantier', label:'Accélérer le chantier (corruption)', pa:2, cost:1500, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant du chantier.'},{fn:'voler_materiel_chantier', label:'Voler du matériel de chantier', pa:2, cost:0, type:'illegal', icon:'ti-truck', successRate:0, desc:'Même le propriétaire peut se voler lui-même — mise en scène parodique, bonus de sympathie publique.'},{fn:'diviser_construction', label:'Diviser / gérer les lots', pa:0, cost:0, type:'legal', icon:'ti-grid-dots', successRate:100, desc:'Réservé aux Commerces Premium et Buildings construits.'},{fn:'reconfigurer_lots', label:'Reconfigurer les lots (chantier)', pa:0, cost:0, type:'legal', icon:'ti-layout-board', successRate:100, desc:'Redecouper un batiment livre : 10 FR par m2 reellement concerne, paye en totalite au lancement. Aucun local sous bail ne peut etre touche.'},{fn:'louer_lot_ici', label:'Louer un lot ici', pa:1, cost:0, type:'legal', icon:'ti-key', successRate:100, desc:'Louer un lot disponible, si ce terrain a été divisé par son propriétaire.'},{fn:'gerer_lot_loue', label:'Gérer mon local loué', pa:0, cost:0, type:'legal', icon:'ti-home-cog', successRate:100, desc:'Voir/accepter les propositions du propriétaire concernant votre lot loué ici.'},{fn:'gerer_fonds_commerce', label:'Mon fonds de commerce', pa:0, cost:0, type:'legal', icon:'ti-building-store', successRate:100, desc:'Creer un fonds de commerce dans ce local, ou gerer sa caisse. Reserve au titulaire du bail.'},{fn:'emprunter_construction', label:'Faire un prêt (Banque Nationale)', pa:0, cost:0, type:'legal', icon:'ti-bank', successRate:100},{fn:'racheter_terrain', label:'Offre de rachat', pa:2, cost:0, type:'legal', icon:'ti-arrows-exchange', successRate:100}] } }
  },
  'terrain-a-batir-6': {
    ...
    rooms: { terrain: { name: "Terrain vague", imageBg: "linear-gradient(135deg,#0a0a05,#12120a)", desc: "Terrain en friche.", imageUrl: "https://images.unsplash.com/photo-1590496793929-36417d3117de?w=1200&q=80", persons: [], orders: [{fn:'appeler_police_terrain', label:'Appeler la police', pa:1, cost:0, type:'legal', icon:'ti-shield', successRate:100},{fn:'faire_disparaitre_cadavre', label:'Faire disparaitre le corps', pa:2, cost:0, type:'illegal', icon:'ti-eye-off', successRate:0, requiresCadavre:true},{fn:'negocier_squatteurs', label:'Negocier le depart', pa:1, cost:0, type:'legal', icon:'ti-messages', successRate:0, requiresSquatteurs:true},{fn:'signer_compromis', label:'Signer un compromis', pa:2, cost:1000, type:'legal', icon:'ti-file-certificate', successRate:100},
          {fn:'acheter_terrain', label:'Acheter ce terrain', pa:2, cost:25000, type:'legal', icon:'ti-home-plus', successRate:100},{fn:'construire_sur_terrain', label:'Construire', pa:0, cost:0, type:'legal', icon:'ti-building', successRate:100},{fn:'corrompre_rdv_notaire', label:'Accélérer le rendez-vous (corruption)', pa:2, cost:800, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant avant le rendez-vous notarial d\'un achat direct.'},{fn:'payer_versement_chantier', label:'Payer le versement du chantier', pa:0, cost:0, type:'legal', icon:'ti-cash', successRate:100, desc:'Régler le versement en attente pour que le chantier reprenne.'},{fn:'travailler_chantier', label:'Travailler sur le chantier', pa:0, cost:0, type:'legal', icon:'ti-hammer', successRate:100, desc:'Une heure de travail = 1 PA, payee 70 FR par la tresorerie du chantier. Vous devez etre sur place.'},{fn:'vendre_materiaux_chantier', label:'Fournir le chantier', pa:0, cost:0, type:'legal', icon:'ti-truck-delivery', successRate:100, desc:'Vendre vos bois, minerai ou metal au chantier, au prix que vous fixez. Vous devez etre sur place.'},{fn:'modifier_plan_chantier', label:'Modifier le plan de decoupage', pa:0, cost:0, type:'legal', icon:'ti-layout-grid', successRate:100, desc:'Remanier gratuitement le decoupage en lots tant que le chantier n a pas atteint les deux tiers. Reserve au proprietaire.'},{fn:'corrompre_chantier', label:'Accélérer le chantier (corruption)', pa:2, cost:1500, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant du chantier.'},{fn:'voler_materiel_chantier', label:'Voler du matériel de chantier', pa:2, cost:0, type:'illegal', icon:'ti-truck', successRate:0, desc:'Même le propriétaire peut se voler lui-même — mise en scène parodique, bonus de sympathie publique.'},{fn:'diviser_construction', label:'Diviser / gérer les lots', pa:0, cost:0, type:'legal', icon:'ti-grid-dots', successRate:100, desc:'Réservé aux Commerces Premium et Buildings construits.'},{fn:'reconfigurer_lots', label:'Reconfigurer les lots (chantier)', pa:0, cost:0, type:'legal', icon:'ti-layout-board', successRate:100, desc:'Redecouper un batiment livre : 10 FR par m2 reellement concerne, paye en totalite au lancement. Aucun local sous bail ne peut etre touche.'},{fn:'louer_lot_ici', label:'Louer un lot ici', pa:1, cost:0, type:'legal', icon:'ti-key', successRate:100, desc:'Louer un lot disponible, si ce terrain a été divisé par son propriétaire.'},{fn:'gerer_lot_loue', label:'Gérer mon local loué', pa:0, cost:0, type:'legal', icon:'ti-home-cog', successRate:100, desc:'Voir/accepter les propositions du propriétaire concernant votre lot loué ici.'},{fn:'gerer_fonds_commerce', label:'Mon fonds de commerce', pa:0, cost:0, type:'legal', icon:'ti-building-store', successRate:100, desc:'Creer un fonds de commerce dans ce local, ou gerer sa caisse. Reserve au titulaire du bail.'},{fn:'emprunter_construction', label:'Faire un prêt (Banque Nationale)', pa:0, cost:0, type:'legal', icon:'ti-bank', successRate:100},{fn:'racheter_terrain', label:'Offre de rachat', pa:2, cost:0, type:'legal', icon:'ti-arrows-exchange', successRate:100}] } }
  },
  'terrain-a-batir-7': {
  ...
  'terrain-a-batir-montrouge-3': {
    ...
    rooms: { terrain: { name: "Terrain vague", imageBg: "linear-gradient(135deg,#0a0a05,#12120a)", desc: "Terrain en friche (1500 m²).", imageUrl: "images/montrouge/montrouge-terrain-lot-3.jpg", persons: [], orders: [{fn:'appeler_police_terrain', label:'Appeler la police', pa:1, cost:0, type:'legal', icon:'ti-shield', successRate:100},{fn:'faire_disparaitre_cadavre', label:'Faire disparaitre le corps', pa:2, cost:0, type:'illegal', icon:'ti-eye-off', successRate:0, requiresCadavre:true},{fn:'negocier_squatteurs', label:'Negocier le depart', pa:1, cost:0, type:'legal', icon:'ti-messages', successRate:0, requiresSquatteurs:true},{fn:'signer_compromis', label:'Signer un compromis', pa:2, cost:1000, type:'legal', icon:'ti-file-certificate', successRate:100},
          {fn:'acheter_terrain', label:'Acheter ce terrain (1500 m² — 18 000 FR)', pa:2, cost:18000, type:'legal', icon:'ti-home-plus', successRate:100},{fn:'construire_sur_terrain', label:'Construire', pa:0, cost:0, type:'legal', icon:'ti-building', successRate:100},{fn:'corrompre_rdv_notaire', label:'Accélérer le rendez-vous (corruption)', pa:2, cost:800, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant avant le rendez-vous notarial d\'un achat direct.'},{fn:'payer_versement_chantier', label:'Payer le versement du chantier', pa:0, cost:0, type:'legal', icon:'ti-cash', successRate:100, desc:'Régler le versement en attente pour que le chantier reprenne.'},{fn:'travailler_chantier', label:'Travailler sur le chantier', pa:0, cost:0, type:'legal', icon:'ti-hammer', successRate:100, desc:'Une heure de travail = 1 PA, payee 70 FR par la tresorerie du chantier. Vous devez etre sur place.'},{fn:'vendre_materiaux_chantier', label:'Fournir le chantier', pa:0, cost:0, type:'legal', icon:'ti-truck-delivery', successRate:100, desc:'Vendre vos bois, minerai ou metal au chantier, au prix que vous fixez. Vous devez etre sur place.'},{fn:'modifier_plan_chantier', label:'Modifier le plan de decoupage', pa:0, cost:0, type:'legal', icon:'ti-layout-grid', successRate:100, desc:'Remanier gratuitement le decoupage en lots tant que le chantier n a pas atteint les deux tiers. Reserve au proprietaire.'},{fn:'corrompre_chantier', label:'Accélérer le chantier (corruption)', pa:2, cost:1500, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant du chantier.'},{fn:'voler_materiel_chantier', label:'Voler du matériel de chantier', pa:2, cost:0, type:'illegal', icon:'ti-truck', successRate:0, desc:'Même le propriétaire peut se voler lui-même — mise en scène parodique, bonus de sympathie publique.'},{fn:'diviser_construction', label:'Diviser / gérer les lots', pa:0, cost:0, type:'legal', icon:'ti-grid-dots', successRate:100, desc:'Réservé aux Commerces Premium et Buildings construits.'},{fn:'reconfigurer_lots', label:'Reconfigurer les lots (chantier)', pa:0, cost:0, type:'legal', icon:'ti-layout-board', successRate:100, desc:'Redecouper un batiment livre : 10 FR par m2 reellement concerne, paye en totalite au lancement. Aucun local sous bail ne peut etre touche.'},{fn:'louer_lot_ici', label:'Louer un lot ici', pa:1, cost:0, type:'legal', icon:'ti-key', successRate:100, desc:'Louer un lot disponible, si ce terrain a été divisé par son propriétaire.'},{fn:'gerer_lot_loue', label:'Gérer mon local loué', pa:0, cost:0, type:'legal', icon:'ti-home-cog', successRate:100, desc:'Voir/accepter les propositions du propriétaire concernant votre lot loué ici.'},{fn:'gerer_fonds_commerce', label:'Mon fonds de commerce', pa:0, cost:0, type:'legal', icon:'ti-building-store', successRate:100, desc:'Creer un fonds de commerce dans ce local, ou gerer sa caisse. Reserve au titulaire du bail.'},{fn:'emprunter_construction', label:'Faire un prêt (Banque Nationale)', pa:0, cost:0, type:'legal', icon:'ti-bank', successRate:100},{fn:'racheter_terrain', label:'Offre de rachat', pa:2, cost:0, type:'legal', icon:'ti-arrows-exchange', successRate:100}] } }
  },
  'terrain-a-batir-montrouge-7': {
    ...
    rooms: { terrain: { name: "Terrain vague", imageBg: "linear-gradient(135deg,#0a0a05,#12120a)", desc: "Terrain en friche (1800 m²).", imageUrl: "images/montrouge/montrouge-terrain-lot-7.jpg", persons: [], orders: [{fn:'appeler_police_terrain', label:'Appeler la police', pa:1, cost:0, type:'legal', icon:'ti-shield', successRate:100},{fn:'faire_disparaitre_cadavre', label:'Faire disparaitre le corps', pa:2, cost:0, type:'illegal', icon:'ti-eye-off', successRate:0, requiresCadavre:true},{fn:'negocier_squatteurs', label:'Negocier le depart', pa:1, cost:0, type:'legal', icon:'ti-messages', successRate:0, requiresSquatteurs:true},{fn:'signer_compromis', label:'Signer un compromis', pa:2, cost:1000, type:'legal', icon:'ti-file-certificate', successRate:100},
          {fn:'acheter_terrain', label:'Acheter ce terrain (1800 m² — 21 600 FR)', pa:2, cost:21600, type:'legal', icon:'ti-home-plus', successRate:100},{fn:'construire_sur_terrain', label:'Construire', pa:0, cost:0, type:'legal', icon:'ti-building', successRate:100},{fn:'corrompre_rdv_notaire', label:'Accélérer le rendez-vous (corruption)', pa:2, cost:800, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant avant le rendez-vous notarial d\'un achat direct.'},{fn:'payer_versement_chantier', label:'Payer le versement du chantier', pa:0, cost:0, type:'legal', icon:'ti-cash', successRate:100, desc:'Régler le versement en attente pour que le chantier reprenne.'},{fn:'travailler_chantier', label:'Travailler sur le chantier', pa:0, cost:0, type:'legal', icon:'ti-hammer', successRate:100, desc:'Une heure de travail = 1 PA, payee 70 FR par la tresorerie du chantier. Vous devez etre sur place.'},{fn:'vendre_materiaux_chantier', label:'Fournir le chantier', pa:0, cost:0, type:'legal', icon:'ti-truck-delivery', successRate:100, desc:'Vendre vos bois, minerai ou metal au chantier, au prix que vous fixez. Vous devez etre sur place.'},{fn:'modifier_plan_chantier', label:'Modifier le plan de decoupage', pa:0, cost:0, type:'legal', icon:'ti-layout-grid', successRate:100, desc:'Remanier gratuitement le decoupage en lots tant que le chantier n a pas atteint les deux tiers. Reserve au proprietaire.'},{fn:'corrompre_chantier', label:'Accélérer le chantier (corruption)', pa:2, cost:1500, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant du chantier.'},{fn:'voler_materiel_chantier', label:'Voler du matériel de chantier', pa:2, cost:0, type:'illegal', icon:'ti-truck', successRate:0, desc:'Même le propriétaire peut se voler lui-même — mise en scène parodique, bonus de sympathie publique.'},{fn:'diviser_construction', label:'Diviser / gérer les lots', pa:0, cost:0, type:'legal', icon:'ti-grid-dots', successRate:100, desc:'Réservé aux Commerces Premium et Buildings construits.'},{fn:'reconfigurer_lots', label:'Reconfigurer les lots (chantier)', pa:0, cost:0, type:'legal', icon:'ti-layout-board', successRate:100, desc:'Redecouper un batiment livre : 10 FR par m2 reellement concerne, paye en totalite au lancement. Aucun local sous bail ne peut etre touche.'},{fn:'louer_lot_ici', label:'Louer un lot ici', pa:1, cost:0, type:'legal', icon:'ti-key', successRate:100, desc:'Louer un lot disponible, si ce terrain a été divisé par son propriétaire.'},{fn:'gerer_lot_loue', label:'Gérer mon local loué', pa:0, cost:0, type:'legal', icon:'ti-home-cog', successRate:100, desc:'Voir/accepter les propositions du propriétaire concernant votre lot loué ici.'},{fn:'gerer_fonds_commerce', label:'Mon fonds de commerce', pa:0, cost:0, type:'legal', icon:'ti-building-store', successRate:100, desc:'Creer un fonds de commerce dans ce local, ou gerer sa caisse. Reserve au titulaire du bail.'},{fn:'emprunter_construction', label:'Faire un prêt (Banque Nationale)', pa:0, cost:0, type:'legal', icon:'ti-bank', successRate:100},{fn:'racheter_terrain', label:'Offre de rachat', pa:2, cost:0, type:'legal', icon:'ti-arrows-exchange', successRate:100}] } }
  },
  ...
  'terrain-a-batir-montrouge-9': {
    ...
    rooms: { terrain: { name: "Terrain vague", imageBg: "linear-gradient(135deg,#0a0a05,#12120a)", desc: "Terrain en friche (2500 m²).", imageUrl: "images/montrouge/montrouge-terrain-lot-9.jpg", persons: [], orders: [{fn:'appeler_police_terrain', label:'Appeler la police', pa:1, cost:0, type:'legal', icon:'ti-shield', successRate:100},{fn:'faire_disparaitre_cadavre', label:'Faire disparaitre le corps', pa:2, cost:0, type:'illegal', icon:'ti-eye-off', successRate:0, requiresCadavre:true},{fn:'negocier_squatteurs', label:'Negocier le depart', pa:1, cost:0, type:'legal', icon:'ti-messages', successRate:0, requiresSquatteurs:true},{fn:'signer_compromis', label:'Signer un compromis', pa:2, cost:1000, type:'legal', icon:'ti-file-certificate', successRate:100},
          {fn:'acheter_terrain', label:'Acheter ce terrain (2500 m² — 30 000 FR)', pa:2, cost:30000, type:'legal', icon:'ti-home-plus', successRate:100},{fn:'construire_sur_terrain', label:'Construire', pa:0, cost:0, type:'legal', icon:'ti-building', successRate:100},{fn:'corrompre_rdv_notaire', label:'Accélérer le rendez-vous (corruption)', pa:2, cost:800, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant avant le rendez-vous notarial d\'un achat direct.'},{fn:'payer_versement_chantier', label:'Payer le versement du chantier', pa:0, cost:0, type:'legal', icon:'ti-cash', successRate:100, desc:'Régler le versement en attente pour que le chantier reprenne.'},{fn:'travailler_chantier', label:'Travailler sur le chantier', pa:0, cost:0, type:'legal', icon:'ti-hammer', successRate:100, desc:'Une heure de travail = 1 PA, payee 70 FR par la tresorerie du chantier. Vous devez etre sur place.'},{fn:'vendre_materiaux_chantier', label:'Fournir le chantier', pa:0, cost:0, type:'legal', icon:'ti-truck-delivery', successRate:100, desc:'Vendre vos bois, minerai ou metal au chantier, au prix que vous fixez. Vous devez etre sur place.'},{fn:'modifier_plan_chantier', label:'Modifier le plan de decoupage', pa:0, cost:0, type:'legal', icon:'ti-layout-grid', successRate:100, desc:'Remanier gratuitement le decoupage en lots tant que le chantier n a pas atteint les deux tiers. Reserve au proprietaire.'},{fn:'corrompre_chantier', label:'Accélérer le chantier (corruption)', pa:2, cost:1500, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant du chantier.'},{fn:'voler_materiel_chantier', label:'Voler du matériel de chantier', pa:2, cost:0, type:'illegal', icon:'ti-truck', successRate:0, desc:'Même le propriétaire peut se voler lui-même — mise en scène parodique, bonus de sympathie publique.'},{fn:'diviser_construction', label:'Diviser / gérer les lots', pa:0, cost:0, type:'legal', icon:'ti-grid-dots', successRate:100, desc:'Réservé aux Commerces Premium et Buildings construits.'},{fn:'reconfigurer_lots', label:'Reconfigurer les lots (chantier)', pa:0, cost:0, type:'legal', icon:'ti-layout-board', successRate:100, desc:'Redecouper un batiment livre : 10 FR par m2 reellement concerne, paye en totalite au lancement. Aucun local sous bail ne peut etre touche.'},{fn:'louer_lot_ici', label:'Louer un lot ici', pa:1, cost:0, type:'legal', icon:'ti-key', successRate:100, desc:'Louer un lot disponible, si ce terrain a été divisé par son propriétaire.'},{fn:'gerer_lot_loue', label:'Gérer mon local loué', pa:0, cost:0, type:'legal', icon:'ti-home-cog', successRate:100, desc:'Voir/accepter les propositions du propriétaire concernant votre lot loué ici.'},{fn:'gerer_fonds_commerce', label:'Mon fonds de commerce', pa:0, cost:0, type:'legal', icon:'ti-building-store', successRate:100, desc:'Creer un fonds de commerce dans ce local, ou gerer sa caisse. Reserve au titulaire du bail.'},{fn:'emprunter_construction', label:'Faire un prêt (Banque Nationale)', pa:0, cost:0, type:'legal', icon:'ti-bank', successRate:100},{fn:'racheter_terrain', label:'Offre de rachat', pa:2, cost:0, type:'legal', icon:'ti-arrows-exchange', successRate:100}] } }
  },
  'terrain-a-batir-montrouge-12': {
    ...
    rooms: { terrain: { name: "Terrain vague", imageBg: "linear-gradient(135deg,#0a0a05,#12120a)", desc: "Terrain en friche (3000 m²).", imageUrl: "images/montrouge/montrouge-terrain-lot-12.jpg", persons: [], orders: [{fn:'appeler_police_terrain', label:'Appeler la police', pa:1, cost:0, type:'legal', icon:'ti-shield', successRate:100},{fn:'faire_disparaitre_cadavre', label:'Faire disparaitre le corps', pa:2, cost:0, type:'illegal', icon:'ti-eye-off', successRate:0, requiresCadavre:true},{fn:'negocier_squatteurs', label:'Negocier le depart', pa:1, cost:0, type:'legal', icon:'ti-messages', successRate:0, requiresSquatteurs:true},{fn:'signer_compromis', label:'Signer un compromis', pa:2, cost:1000, type:'legal', icon:'ti-file-certificate', successRate:100},
          {fn:'acheter_terrain', label:'Acheter ce terrain (3000 m² — 36 000 FR)', pa:2, cost:36000, type:'legal', icon:'ti-home-plus', successRate:100},{fn:'construire_sur_terrain', label:'Construire', pa:0, cost:0, type:'legal', icon:'ti-building', successRate:100},{fn:'corrompre_rdv_notaire', label:'Accélérer le rendez-vous (corruption)', pa:2, cost:800, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant avant le rendez-vous notarial d\'un achat direct.'},{fn:'payer_versement_chantier', label:'Payer le versement du chantier', pa:0, cost:0, type:'legal', icon:'ti-cash', successRate:100, desc:'Régler le versement en attente pour que le chantier reprenne.'},{fn:'travailler_chantier', label:'Travailler sur le chantier', pa:0, cost:0, type:'legal', icon:'ti-hammer', successRate:100, desc:'Une heure de travail = 1 PA, payee 70 FR par la tresorerie du chantier. Vous devez etre sur place.'},{fn:'vendre_materiaux_chantier', label:'Fournir le chantier', pa:0, cost:0, type:'legal', icon:'ti-truck-delivery', successRate:100, desc:'Vendre vos bois, minerai ou metal au chantier, au prix que vous fixez. Vous devez etre sur place.'},{fn:'modifier_plan_chantier', label:'Modifier le plan de decoupage', pa:0, cost:0, type:'legal', icon:'ti-layout-grid', successRate:100, desc:'Remanier gratuitement le decoupage en lots tant que le chantier n a pas atteint les deux tiers. Reserve au proprietaire.'},{fn:'corrompre_chantier', label:'Accélérer le chantier (corruption)', pa:2, cost:1500, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant du chantier.'},{fn:'voler_materiel_chantier', label:'Voler du matériel de chantier', pa:2, cost:0, type:'illegal', icon:'ti-truck', successRate:0, desc:'Même le propriétaire peut se voler lui-même — mise en scène parodique, bonus de sympathie publique.'},{fn:'diviser_construction', label:'Diviser / gérer les lots', pa:0, cost:0, type:'legal', icon:'ti-grid-dots', successRate:100, desc:'Réservé aux Commerces Premium et Buildings construits.'},{fn:'reconfigurer_lots', label:'Reconfigurer les lots (chantier)', pa:0, cost:0, type:'legal', icon:'ti-layout-board', successRate:100, desc:'Redecouper un batiment livre : 10 FR par m2 reellement concerne, paye en totalite au lancement. Aucun local sous bail ne peut etre touche.'},{fn:'louer_lot_ici', label:'Louer un lot ici', pa:1, cost:0, type:'legal', icon:'ti-key', successRate:100, desc:'Louer un lot disponible, si ce terrain a été divisé par son propriétaire.'},{fn:'gerer_lot_loue', label:'Gérer mon local loué', pa:0, cost:0, type:'legal', icon:'ti-home-cog', successRate:100, desc:'Voir/accepter les propositions du propriétaire concernant votre lot loué ici.'},{fn:'gerer_fonds_commerce', label:'Mon fonds de commerce', pa:0, cost:0, type:'legal', icon:'ti-building-store', successRate:100, desc:'Creer un fonds de commerce dans ce local, ou gerer sa caisse. Reserve au titulaire du bail.'},{fn:'emprunter_construction', label:'Faire un prêt (Banque Nationale)', pa:0, cost:0, type:'legal', icon:'ti-bank', successRate:100},{fn:'racheter_terrain', label:'Offre de rachat', pa:2, cost:0, type:'legal', icon:'ti-arrows-exchange', successRate:100}] } }
  },
  'terrain-a-batir-1': {
    ...
    rooms: {
      terrain: {
        ...
        orders: [
          ...
          {fn:'construire_sur_terrain', label:'Construire', pa:0, cost:0, type:'legal', icon:'ti-building', successRate:100},{fn:'corrompre_rdv_notaire', label:'Accélérer le rendez-vous (corruption)', pa:2, cost:800, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant avant le rendez-vous notarial d\'un achat direct.'},{fn:'payer_versement_chantier', label:'Payer le versement du chantier', pa:0, cost:0, type:'legal', icon:'ti-cash', successRate:100, desc:'Régler le versement en attente pour que le chantier reprenne.'},{fn:'travailler_chantier', label:'Travailler sur le chantier', pa:0, cost:0, type:'legal', icon:'ti-hammer', successRate:100, desc:'Une heure de travail = 1 PA, payee 70 FR par la tresorerie du chantier. Vous devez etre sur place.'},{fn:'vendre_materiaux_chantier', label:'Fournir le chantier', pa:0, cost:0, type:'legal', icon:'ti-truck-delivery', successRate:100, desc:'Vendre vos bois, minerai ou metal au chantier, au prix que vous fixez. Vous devez etre sur place.'},{fn:'modifier_plan_chantier', label:'Modifier le plan de decoupage', pa:0, cost:0, type:'legal', icon:'ti-layout-grid', successRate:100, desc:'Remanier gratuitement le decoupage en lots tant que le chantier n a pas atteint les deux tiers. Reserve au proprietaire.'},{fn:'corrompre_chantier', label:'Accélérer le chantier (corruption)', pa:2, cost:1500, type:'illegal', icon:'ti-coins', successRate:100, desc:'Réduit de moitié le délai restant du chantier.'},{fn:'voler_materiel_chantier', label:'Voler du matériel de chantier', pa:2, cost:0, type:'illegal', icon:'ti-truck', successRate:0, desc:'Même le propriétaire peut se voler lui-même — mise en scène parodique, bonus de sympathie publique.'},{fn:'diviser_construction', label:'Diviser / gérer les lots', pa:0, cost:0, type:'legal', icon:'ti-grid-dots', successRate:100, desc:'Réservé aux Commerces Premium et Buildings construits.'},{fn:'reconfigurer_lots', label:'Reconfigurer les lots (chantier)', pa:0, cost:0, type:'legal', icon:'ti-layout-board', successRate:100, desc:'Redecouper un batiment livre : 10 FR par m2 reellement concerne, paye en totalite au lancement. Aucun local sous bail ne peut etre touche.'},{fn:'louer_lot_ici', label:'Louer un lot ici', pa:1, cost:0, type:'legal', icon:'ti-key', successRate:100, desc:'Louer un lot disponible, si ce terrain a été divisé par son propriétaire.'},{fn:'gerer_lot_loue', label:'Gérer mon local loué', pa:0, cost:0, type:'legal', icon:'ti-home-cog', successRate:100, desc:'Voir/accepter les propositions du propriétaire concernant votre lot loué ici.'},{fn:'gerer_fonds_commerce', label:'Mon fonds de commerce', pa:0, cost:0, type:'legal', icon:'ti-building-store', successRate:100, desc:'Creer un fonds de commerce dans ce local, ou gerer sa caisse. Reserve au titulaire du bail.'},
...
const SALAIRES = {
  ...
  // (soldat 50, lieutenant 150, capitaine 250, commandant 400) sont desormais versees par la
  // RPC militaire_solde_percevoir, qui debite reellement la caisse de la caserne et inscrit une
  // DETTE nominative pour ce qu'elle ne peut pas payer. Les remettre ici les paierait DEUX fois,
  // dont une en monnaie inventee.
